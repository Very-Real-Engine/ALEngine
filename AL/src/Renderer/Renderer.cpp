...
void Renderer::recordColliderCommandBuffer(Scene *scene, VkCommandBuffer commandBuffer)
{
	...
	for (auto entity : view)
	{
		...
		glm::vec3 center = sphereColliderComponent.m_Center;

		auto &transform = view.get<TransformComponent>(entity);
		ubo.model = glm::translate(glm::mat4(1.0f), transform.m_Position);
		ubo.model = glm::translate(ubo.model, center);
		ubo.model = glm::rotate(ubo.model, transform.m_Rotation.x, glm::vec3(1.0f, 0.0f, 0.0f));
		ubo.model = glm::rotate(ubo.model, transform.m_Rotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
		ubo.model = glm::rotate(ubo.model, transform.m_Rotation.z, glm::vec3(0.0f, 0.0f, 1.0f));
		ubo.model = glm::scale(ubo.model, glm::vec3(radius * 2.0f));
	...
	for (auto entity : view2)
	{
		...
		glm::vec3 size = boxColliderComponent.m_Size;
		glm::vec3 center = boxColliderComponent.m_Center;
		...
		ubo.model = glm::rotate(ubo.model, transform.m_Rotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
		ubo.model = glm::rotate(ubo.model, transform.m_Rotation.z, glm::vec3(0.0f, 0.0f, 1.0f));
		ubo.model = glm::scale(ubo.model, size);
	...
	for (auto entity : view3)
	{
		...
		glm::vec3 center = capsuleColliderComponent.m_Center;
		...
		ubo.model = glm::rotate(ubo.model, transform.m_Rotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
		ubo.model = glm::rotate(ubo.model, transform.m_Rotation.z, glm::vec3(0.0f, 0.0f, 1.0f));
		ubo.model = glm::scale(ubo.model, glm::vec3(radius * 2.0f, height, radius * 2.0f));
	...
	for (auto entity : view4)
	{
		...
		glm::vec3 center = cylinderColliderComponent.m_Center;
